    ...
    <div class="container-edit-pilote">
      <div class="top-box-position">
        ...
        <form action="" method="get">
          <input class="form-control" type="search" name="terme" placeholder="Rechercher..." aria-label="Rechercher">
          <input class="btn btn-recherche" type="submit" name="submit" value="Rechercher">
          <a href="index.php?module=pilotes&action=create" class="btn btn-primary">Ajouter</a>
        </form>
      </div>
