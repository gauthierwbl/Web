...
class PilotesModel {
    ...
    /**
     * Rechercher des pilotes dans le dashboard
     */
    public function rechercherPilotesDashboard($terme) {
        try {
            $query = "
                SELECT u.id_utilisateurs, u.login, u.date_inscription,
                       i.nom, i.prenom, a.adresse, v.nom_ville, v.zipcode
            ...
            error_log("Erreur lors de la recherche de pilotes dans le dashboard : " . $e->getMessage());
            return [];
        }
    }
    ...
    public function create($login, $mot_de_passe, $nom, $prenom, $adresse, $id_ville) {
        try {
            ...
            $this->pdo->rollBack();
            error_log("Erreur lors de la création d'un pilote : " . $e->getMessage());
            return false;
        }
    }
    ...
    public function update($id, $login, $mot_de_passe = null, $nom, $prenom, $adresse, $id_ville) {
        try {
            ...
            if (!$ids) {
                throw new PDOException("Pilote non trouvé.");
            }
            ...
            // En cas d'erreur, annuler toutes les modifications
            $this->pdo->rollBack();
            error_log("Erreur lors de la mise à jour d'un pilote : " . $e->getMessage());
            return false;
        }
    }
    ...
    public function delete($id) {
        try {
            ...
            error_log("Erreur lors de la suppression d'un pilote : " . $e->getMessage());
            return false;
        }
    }
}