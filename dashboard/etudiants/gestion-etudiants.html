  ...
  <section class="container-admin">
    <div class="container-edit-etudiant">
      <div class="top-box-position">
        ...
        <a href="admin-etudiants-add.html" class="btn btn-primary">Ajouter</a>
      </div>
      <table>
        <thead>
          <tr>
        ...
        <tbody>
          <tr>
            <td>
              <a class="texte-tableau" href="admin-etudiants.html">1</a>
            </td>
            <td>
              <a class="texte-tableau" href="admin-etudiants.html">Étudiant Exemple</a>
            </td>
            <td>
              <a href="admin-etudiants-edit.html" class="btn btn-primary-etudiant">
                <span class="sr-only">Modifier l'étudiant</span>
                <i class="fas fa-edit"></i>
              </a>
              <form action="admin-etudiants-delete.html" method="POST" style="display: inline;" onsubmit="return confirm('Voulez-vous supprimer cet étudiant ?')">
                <button class="btn btn-danger-etudiant">
                  <span class="sr-only">Supprimer l'étudiant</span>
